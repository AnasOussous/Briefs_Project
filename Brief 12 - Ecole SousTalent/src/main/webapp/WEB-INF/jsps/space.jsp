...
<body>
	...
	<header>
		<nav class="ccsticky-nav">
			...
			<ul>
				<li><a href="<%=request.getContextPath()%>/add"><i
						class="fa fa-plus add"></i></a></li>
				<li><a href="<%=request.getContextPath()%>/profile"><i
						class="fa fa-cog par"></i></a></li>
			...
			<table class="styled-table">
				...
				<tbody>
					<%--c:forEach var="employee" items="${listEmployees}"--%>
						...
						<% DaoImp employeeDao = new DaoImp();%>
						<%for (Etudiant etudiant : employeeDao.selectAllEmployees()) {
										%>
						<tr>
						
							<td><%= etudiant.getIdemployee() %>  </td>
							<td><%= etudiant.getFullname() %>  </td>
							<td><%= etudiant.getEmail() %>  </td>
							<td><%= etudiant.getDepartement() %>  </td>

			 				<td>
                     <a id="edit" href="edit?id=<%=employee.getIdemployee()%>">Edit</a>
                     &nbsp;&nbsp;&nbsp;&nbsp;
                     <a href="delete?id=<%=employee.getIdemployee()%>">Delete</a>                     
                    </td>
